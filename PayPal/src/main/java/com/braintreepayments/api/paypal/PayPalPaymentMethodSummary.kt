...
/**
 * A single vaulted funding instrument returned by the `getSavedPaypalPaymentMethod` query.
 *
...
/**
 * The parsed result of a `getSavedPaypalPaymentMethod` read.
 *
...
data class PayPalPaymentMethodSummary internal constructor(
    ...
    internal companion object {
        ...
        private const val GET_SAVED_PAYPAL_PAYMENT_METHOD_KEY = "getSavedPaypalPaymentMethod"
        ...
        fun fromJson(response: JSONObject): PayPalPaymentMethodSummary {
            val payload = response
                ...
                ?.optJSONObject(GET_SAVED_PAYPAL_PAYMENT_METHOD_KEY)
