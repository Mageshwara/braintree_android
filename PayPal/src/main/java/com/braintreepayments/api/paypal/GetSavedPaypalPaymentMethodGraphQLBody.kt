...
/**
 * Builds the request body for the shared `getSavedPaypalPaymentMethod` GraphQL operation. One
...
internal object GetSavedPaypalPaymentMethodGraphQLBody {
    ...
    private const val QUERY =
        "query GetSavedPaypalPaymentMethod(\$input: getSavedPaypalPaymentMethodInput!) { " +
            "getSavedPaypalPaymentMethod(input: \$input) { " +
